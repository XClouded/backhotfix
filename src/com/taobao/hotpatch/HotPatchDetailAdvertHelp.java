...
public class HotPatchDetailAdvertHelp implements IPatch {
    ...
    @Override public void handlePatch(PatchParam patchParam) throws Throwable {
        ...
        final Class<?> detailAdvertHelpClass = PatchHelper.loadClass(context,"com.taobao.tao.detail.activity.help.a","com.taobao.android.newtrade",this);
        ...
        if(null == locationStoreClass){
            Log.e(TAG, "locationStoreClass not found");
            return;
        }
        ...
        XposedBridge.findAndHookMethod(detailAdvertHelpClass, "sendDujuanInfo", Uri.class, String.class,
                String.class, boolean.class, Activity.class, new XC_MethodReplacement() {
                    @Override protected Object replaceHookedMethod(MethodHookParam methodHookParam)
                            throws Throwable {
                        try {
                            ...
                            Application application = (Application) XposedHelpers.callStaticMethod(commonUtilsClass,"getApplication");
                            ...
                            Map<String, String> locateMap = (Map<String, String>) XposedHelpers.callStaticMethod(locationStoreClass,"getLocationInfo",new Class[]{Context.class},application);
                            ...
                            Object munion = XposedHelpers.callStaticMethod(munionClass,"getInstance",new Class[]{Context.class,Bundle.class},application,bundle);
                            ...
                            if (uri != null) {
                                ...
                                try {
                                    XposedHelpers.callMethod(munion,"inVoke",new Class[]{String.class},eUrl);
                                } catch (Exception e) {
                                    Log.e(TAG, e.toString());
                                }
                            }

                            String clickId = (String) XposedHelpers.callMethod(munion,"commitEvent", new Class[]{String.class,long.class,long.class,long.class,String.class,int.class},eUrl,seller_Id,0,itemId,sid,tmall);
                            ...
                            if (!TextUtils.isEmpty(clickId)) {
                                ...
                                XposedHelpers.callStaticMethod(trackUtilsClass,"pageUpdate",new Class[]{Activity.class,String.class,Properties.class},activity,"DetailActivity",p);
                            }
                            // ===================== END =====================
