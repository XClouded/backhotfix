...
public class HotPatchFeedStreamViewControler implements IPatch {
	...
	public void handlePatch(final PatchParam arg0) throws Throwable {
		...
		try {
			...
			Log.d("HotPatch_pkg", "invoke FeedStreamViewControler  class success");
		} catch (ClassNotFoundException e) {
			Log.e("HotPatch_pkg", "invoke FeedStreamViewControler  class failed" + e.toString());
		}
		...
		XposedBridge.findAndHookMethod(FeedStreamViewControler, "jumpToDarenSquare", new XC_MethodReplacement() {
					...
					protected Object replaceHookedMethod(MethodHookParam args0)
							throws Throwable {
						Log.d("HotPatch_pkg", "start hotpatch FeedStreamViewControler jumpToDarenSquare");
						...
						Log.d("HotPatch_pkg", "end hotpatch FeedStreamViewControler jumpToDarenSquare");
						return null;
					}
