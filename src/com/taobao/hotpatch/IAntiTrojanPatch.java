...
public class IAntiTrojanPatch implements IPatch{
    ...
    public void handlePatch(PatchParam arg0) throws Throwable {
        ...
        final Class<?> iAntiTrojan = PatchHelper.loadClass(context, "com.taobao.infsword.client.IAntiTrojan", null, this);
        if (iAntiTrojan == null) {
            return;
        }
        ...
        XposedBridge.findAndHookMethod(iAntiTrojan, "init", new XC_MethodHook() {
                    // 这个方法执行的相当于在原initView方法后面，加上一段逻辑。
                    @Override
                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                        KGB.setEnvMode(EnvModeEnum.ONLINE);
                        Log.e("IAntiTrojanPatch", "beforeHookedMethod");
                    }
                });
    }
